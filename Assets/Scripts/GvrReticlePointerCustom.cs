...
public class GvrReticlePointerCustom : GvrBasePointer
{
    ...
    public float GetReticleInnerDiameter()
    {
        return ReticleInnerDiameter;
    }
    ...
    public override void GetPointerRadius(out float enterRadius, out float exitRadius)
    {
        ...
        float max_inner_angle_radians =
            Mathf.Deg2Rad * (RETICLE_MAX_INNER_ANGLE + RETICLE_GROWTH_ANGLE);
    ...
    public void UpdateDiameters()
    {
      ...
      Mathf.Clamp(ReticleDistanceInMeters, RETICLE_DISTANCE_MIN, maxReticleDistance);
        ...
        {
            ReticleOuterAngle = RETICLE_MAX_INNER_ANGLE;
        }
